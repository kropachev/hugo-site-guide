...
Требует страницу поиска `content/page/search/index.md` (если её ещё нет — см. раздел [Сайдбар, меню и соцсети](03-sidebar-and-menu.md)):
...
Базовый виджет — отображает любую таксономию. `categories` и `tag-cloud` — его обёртки. Используйте напрямую, если добавили собственную таксономию, например `series`.
